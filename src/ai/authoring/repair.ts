...
export function buildRepairToolPrompt(input: {
  ...
  return [
    ...
    "Repair scope is structural: preserve the original semantic intent, fields, SQL, chart choice, and layout intent where present; fix only invalid tool-input shape and canonical contract mismatches.",
