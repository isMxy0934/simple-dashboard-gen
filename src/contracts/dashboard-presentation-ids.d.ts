...
export declare const DASHBOARD_COLOR_THEME_ID_TEAL: "teal";
export declare const DASHBOARD_VIEW_STYLE_ID_CLEAN: "clean";
export declare const DASHBOARD_VIEW_STYLE_ID_GRADIENT: "gradient";
...
export declare const DASHBOARD_COLOR_THEME_IDS: readonly [
  typeof DASHBOARD_COLOR_THEME_ID_PURPLE,
  typeof DASHBOARD_COLOR_THEME_ID_TEAL,
];

export declare const DASHBOARD_VIEW_STYLE_IDS: readonly [
  typeof DASHBOARD_VIEW_STYLE_ID_CLEAN,
  typeof DASHBOARD_VIEW_STYLE_ID_GRADIENT,
  typeof DASHBOARD_VIEW_STYLE_ID_EMPHASIS,
];
