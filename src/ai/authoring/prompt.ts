...
> = {
  ...
  authoring: () => [
    ...
    "If getDraftStatus reports data_mode_undecided or next_required_action=decide_data_mode, ask the single mock-vs-live blocker question and do not call write tools.",
