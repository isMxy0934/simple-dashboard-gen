...
> = {
  ...
  authoring: () => [
    ...
    "After staging a query, view, or binding, call getDraftStatus when you need to know what remains. getDraftStatus is read-only and tells you the next missing draft piece.",
    "If getDraftStatus reports missing_required_bindings, call upsertBinding for the missing slots yourself. Do not ask the user to send 'continue' for internal staging work.",
