export const UPSERT_QUERY_TOOL_CONTRACT = [
  ...
  "Staging a query is not a user-visible completed report. Continue with upsertView and upsertBinding; composePatch will become available only after the draft is complete.",
...
export const UPSERT_VIEW_TOOL_CONTRACT = [
  ...
  "This is a write tool for an active dashboard creation/edit. Do not call it for discovery, advisory, planning, or 'how should we analyze this' questions.",
  "Call it only after the latest user turn requests a concrete dashboard output, asks to create/build/generate/add a report, or confirms a specific report you just recommended.",
  "Staging a view is not a user-visible completed report. Continue with upsertQuery and upsertBinding; composePatch will become available only after the draft is complete.",
...
export const UPSERT_BINDING_TOOL_CONTRACT = [
  ...
  "This is a write tool for an active dashboard creation/edit. Do not call it for discovery, advisory, planning, or 'how should we analyze this' questions.",
  "Call it only after the latest user turn requests a concrete dashboard output, asks to create/build/generate/add a report, or confirms a specific report you just recommended.",
  "Staging a binding is not a user-visible completed report. When every required view slot is bound and composePatch is available, call composePatch and then stop for local approval.",
